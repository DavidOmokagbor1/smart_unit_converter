/**
 * HomeScreen - Optimized conversion screen with glassmorphism design
 * Fully optimized to match the stunning web app design
 */
...
export default function HomeScreen() {
  ...
  // Initialize app with proper data
  ...
  const toggleFavorite = useCallback(async (unitId) => {
    try {
      const favorites = await AsyncStorage.getItem('favoriteUnits');
