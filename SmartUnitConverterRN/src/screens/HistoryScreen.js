/**
 * HistoryScreen - Conversion history management
 */
...
const HistoryScreen = () => {
  ...
  const exportHistory = async () => {
    ...
    try {
      const csv = 'Timestamp,From Value,From Unit,To Value,To Unit,Category\n' +
        history.map(conv => 
          `${conv.timestamp},${conv.fromValue},${conv.fromUnit},${conv.toValue},${conv.toUnit},${conv.category}`
        ).join('\n');
